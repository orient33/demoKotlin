...
public class BasicManagedProfileFragment extends Fragment
     ...
     * Tag for logging.
     */
    private static final String TAG = "BasicManagedProfileF";

    /**
     * Package name of calculator
     */
    private static final String PACKAGE_NAME_CALCULATOR = "com.cyanogenmod.eleven";

    /**
     * Package name of Chrome
     */
    private static final String PACKAGE_NAME_CHROME = "com.miui.calculator";
...
//                    int userId = UserHandle.myUserId(); //对于三方app.
